...
pos_type = 'sta'
url      =   "http://www.fangraphs.com/leaders.aspx?pos=all&stats={0}&lg=all&qual=12&type=8&season=2017&month=0&season1=2017&ind=0&team=0&rost=0&age=0&filter=&players=0&page=1_1000".format(pos_type)
r               = requests.get(url)
...
for dude in dudes:
    dude_name = dude[0]
    print dude_name
    print df.loc[df['Name'] == dude_name].iloc[0][0]
...
df.to_csv(r"C:\Fantasy\Fantasy MVP\Pitching Clusters 20170925.csv", index = False)